            ...
            case InventoryTransactionPacket::TYPE_USE_ITEM_ON_ENTITY:
                ...
                switch($type){
                    ...
                    case InventoryTransactionPacket::USE_ITEM_ON_ENTITY_ACTION_ATTACK:
						...
						if($ev->getDamage(EntityDamageEvent::MODIFIER_CRITICAL) > 0){							$pk = new AnimatePacket();							$pk->action = AnimatePacket::ACTION_CRITICAL_HIT;
							$pk->entityRuntimeId = $target->getId();
							$this->server->broadcastPacket($target->getViewers(), $pk);							if($target instanceof Player){								$target->dataPacket($pk);							}						}
